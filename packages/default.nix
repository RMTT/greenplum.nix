...
let
    repo_pkgs = rec {
        ...
        "6.23.3" = pkgs.callPackage ./greenplum6.nix {
        ...
        "6X_STABLE" = pkgs.callPackage ./greenplum6.nix {
            stdenv = pkgs.gcc8Stdenv;
            makeFlags = ["-j8"];
            rev = "5ee1530829413dd820d82178e289f7cc8c7be363";
        };

        main = pkgs.callPackage ./greenplum7.nix {
            stdenv = pkgs.gcc12Stdenv;
            makeFlags = ["-j8"];
            rev = "18710643c4a00bfa99c2ed4f54c19c4d03b5394e";
        };

        "7.0.0.beta-1" = pkgs.callPackage ./greenplum7.nix {
            stdenv = pkgs.gcc12Stdenv;
            makeFlags = ["-j8"];
